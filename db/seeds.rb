...
# Reset auto-increment sequence for Task table
ActiveRecord::Base.connection.execute("DELETE FROM sqlite_sequence WHERE name = 'tasks'")
# Reset auto-increment sequence for Board table
ActiveRecord::Base.connection.execute("DELETE FROM sqlite_sequence WHERE name = 'boards'")
# Reset auto-increment sequence for Project table
...
client4_backlog = client4.boards.build(name: 'Backlog')
